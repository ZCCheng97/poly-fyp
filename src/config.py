...
ffn_cv = {
  ...
  "output_name": "polybert_ffn_morgan_10fold_90_10_unfrozen_seed42", # remember to not include .csv for this particular variable, used to name the model file also

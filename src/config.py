...
ffn_cv = {
  ...
  "output_name": "chemberta_ffn_morgan_90_10_new_gradunfreeze_2048", # remember to not include .csv for this particular variable, used to name the model file also
